#!/bin/bash
#SBATCH --job-name=livusdbg     # job name
...
#SBATCH --output=fivelog/livusdbg.out # output file name # add %j to id the job
#SBATCH --error=fivelog/livusdbg.err  # error file name # add %j to id the job
# # #     SBATCH -C v100-32g
...
# Training
python mainLivus.py -m model=nnunet dataset=livus training=training_livus #nnword
