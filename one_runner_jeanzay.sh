#!/bin/bash
#SBATCH --job-name=m_usnn     # job name
...
#SBATCH --output=logs/m_usnn%j.out # output file name # add %j to id the job
#SBATCH --error=logs/m_usnn%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
