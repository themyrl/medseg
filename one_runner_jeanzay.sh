#!/bin/bash
#SBATCH --job-name=m_ctnn     # job name
...
#SBATCH --output=logs/m_ctnn%j.out # output file name # add %j to id the job
#SBATCH --error=logs/m_ctnn%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
