#!/bin/bash
#SBATCH --job-name=m_ctnn_gda     # job name
...
#SBATCH --output=logs/m_ctnn_gda%j.out # output file name # add %j to id the job
#SBATCH --error=logs/m_ctnn_gda%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
