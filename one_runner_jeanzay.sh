#!/bin/bash
#SBATCH --job-name=m_ctco_gda     # job name
...
#SBATCH --output=logs/m_ctco_gda%j.out # output file name # add %j to id the job
#SBATCH --error=logs/m_ctco_gda%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
