#!/bin/bash
#SBATCH --job-name=sv2ctglv2     # job name
...
#SBATCH --output=multilogs/sv2ctglv2%j.out # output file name # add %j to id the job
#SBATCH --error=multilogs/sv2ctglv2%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
