#!/bin/bash
#SBATCH --job-name=v2usgl     # job name
...
#SBATCH --output=logs/v2usgl%j.out # output file name # add %j to id the job
#SBATCH --error=logs/v2usgl%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
