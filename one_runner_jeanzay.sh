#!/bin/bash
#SBATCH --job-name=sv2ctco     # job name
...
#SBATCH --output=logs/sv2ctco%j.out # output file name # add %j to id the job
#SBATCH --error=logs/sv2ctco%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
