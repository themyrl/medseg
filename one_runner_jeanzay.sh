#!/bin/bash
#SBATCH --job-name=cv2ctnn     # job name
...
#SBATCH --output=logs/cv2ctnn%j.out # output file name # add %j to id the job
#SBATCH --error=logs/cv2ctnn%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
