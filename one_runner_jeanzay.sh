#!/bin/bash
#SBATCH --job-name=sv2usnn     # job name
...
#SBATCH --output=logs/sv2usnn%j.out # output file name # add %j to id the job
#SBATCH --error=logs/sv2usnn%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
