#!/bin/bash
#SBATCH --job-name=dbgr3v2usglv2     # job name
...
#SBATCH --output=multilogs/dbgr3v2usglv2%j.out # output file name # add %j to id the job
#SBATCH --error=multilogs/dbgr3v2usglv2%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
...
# python mainDoubleV2.py -m model=glam model.name=GLAMv2_r2 dataset=us_128_double_jz_v2 training=training_128_jz_v2 dataset.cv=$1 #r3v2usglv2
python mainDoubleV2.py -m model=glam model.name=GLAMv2_r2dbg dataset=us_128_double_jz_v2 training=training_128_jz_v2 dataset.cv=$1 #dbgr3v2usglv2
...
# python mainV2.py -m model=cotr dataset=us_128_simple_jz_v2 training=training_128_jz_v2 dataset.cv=$1 training.checkpoint.load=True training.only_val=True #evsv2usco
