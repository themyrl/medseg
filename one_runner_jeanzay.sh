...
#SBATCH --output=multilogs/dbgr3v2usglv2.out # output file name # add %j to id the job
#SBATCH --error=multilogs/dbgr3v2usglv2.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
...
python mainDoubleV2.py -m model=glam model.name=GLAMv2_r2_dbg2 dataset=us_128_double_jz_v2 training=training_128_jz_v2 dataset.cv=$1 #dbgr3v2usglv2
