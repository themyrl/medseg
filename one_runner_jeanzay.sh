#!/bin/bash
#SBATCH --job-name=sv2ctgl     # job name
...
#SBATCH --output=multilogs/sv2ctgl%j.out # output file name # add %j to id the job
#SBATCH --error=multilogs/sv2ctgl%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
