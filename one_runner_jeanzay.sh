#!/bin/bash
#SBATCH --job-name=m_usco     # job name
...
#SBATCH --output=logs/m_usco%j.out # output file name # add %j to id the job
#SBATCH --error=logs/m_usco%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
