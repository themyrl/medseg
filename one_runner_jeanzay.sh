#!/bin/bash
#SBATCH --job-name=v2usco     # job name
...
#SBATCH --output=logs/v2usco%j.out # output file name # add %j to id the job
#SBATCH --error=logs/v2usco%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
