#!/bin/bash
#SBATCH --job-name=ctcotr     # job name
...
#SBATCH --output=logs/ctcotr%j.out # output file name # add %j to id the job
#SBATCH --error=logs/ctcotr%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
