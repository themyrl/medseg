#!/bin/bash
#SBATCH --job-name=v2ctgl     # job name
...
#SBATCH --output=logs/v2ctgl%j.out # output file name # add %j to id the job
#SBATCH --error=logs/v2ctgl%j.err  # error file name # add %j to id the job
# # #   SBATCH -C v100-32g
...
# python mainDoubleV2.py -m model=glam dataset=us_128_double_jz_v2 training=training_128_jz_v2 dataset.cv=$1 #v2ctgl
