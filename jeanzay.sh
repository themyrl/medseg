#!/bin/bash
#SBATCH --job-name=fuctnn     # job name
...
#SBATCH --output=logs/fuctnn.out # output file name # add %j to id the job
#SBATCH --error=logs/fuctnn.err  # error file name # add %j to id the job
#   SBATCH -C v100-32g
