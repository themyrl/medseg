#!/bin/bash
#SBATCH --job-name=unetr_gdadbg     # job name
...
#SBATCH --output=logs/unetr_gdadbg.out # output file name # add %j to id the job
#SBATCH --error=logs/unetr_gdadbg.err  # error file name # add %j to id the job
#   SBATCH -C v100-32g
